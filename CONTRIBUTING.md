...
- a local clone of this project
  ```zsh
  git clone https://github.com/amanyagami/Fine_Tuning_Vision_Transformers_Cifar100.git  # HTTPS
  git clone git@github.com:amanyagami/Fine_Tuning_Vision_Transformers_Cifar100.git  # SSH
  ```
